...
const Form = ({
  ...
  return (
    <div className="Wholeform h-screen flex items-center justify-center">
       
        <div className={isSignInPage?" Mainform w-[500px] h-[500px] shadow-lg rounded-lg flex flex-col justify-center items-center":"Mainform w-[500px] h-[600px] shadow-lg rounded-lg flex flex-col justify-center items-center"}>
            <div className=" mb-3 text-4xl font-extrabold">Welcome{isSignInPage && 'Back'}</div>
            ...
            <Button label={isSignInPage ? 'Sign in': 'Sign up'} type='submit' className="w-[75%] mb-2" onClick={()=>{"Your account is registered Please go for login"}} />
            </form>
